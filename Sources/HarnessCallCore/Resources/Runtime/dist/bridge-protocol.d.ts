...
import type { McpCallToolResult, McpGetPromptResult, McpPrompt, McpReadResourceResult, McpResource, McpServerConfiguration, McpServerStatus, McpTool } from "./mcp.js";
...
export type BridgeCommand = {
    ...
    v: typeof BRIDGE_PROTOCOL_VERSION;
    id: string;
    op: "mcp-list-resources";
    server?: string;
} | {
    v: typeof BRIDGE_PROTOCOL_VERSION;
    id: string;
    op: "mcp-read-resource";
    server: string;
    uri: string;
} | {
    v: typeof BRIDGE_PROTOCOL_VERSION;
...
export type BridgeMessage = {
    ...
    resourceResult: McpReadResourceResult;
} | {
    v: typeof BRIDGE_PROTOCOL_VERSION;
    id: string;
    type: "mcp-prompts";
